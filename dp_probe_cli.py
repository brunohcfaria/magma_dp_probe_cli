...
class DpProbe:
    """Class for dp_probe cli
        ...
        BRUNO: Modified to not rely on the the requriement of 
        Magma python environment setup in production environments
    """
    ...
    def create_parser(self):
        ...
        parser.add_argument(
            "-n", "--nat-enabled", required=True,
            default=True,
            help="If NAT mode is enabled or not (pipeliled.mconfig)",
        )
    ...
    def find_ue_ip(self, imsi: str):
        ...
        cmd = ["docker",  "exec",  "-it",  "magmad", "mobility_cli.py",  "get_subscriber_table"]
    ...
    def get_enforced_rules(self, args):
        ...
        cmd = ["docker",  "exec",  "-it",  "magmad", "pipelined_cli.py", "enforcement", "display_flows"]
